...
$sql="INSERT INTO persona(dni,cuil, apellido, nombre, localidad, domicilio, telefono, celular, email, fech_nac, activo )
VALUES('$dni','$cuil', '$apellido' , '$nombre', $localidad , '$domicilio' , '$telefono_fijo' ,
