...
echo '</table>';
 echo '<button type="button" class="btn btn-primary usar">USAR</button>';

 echo '<button type="button" class="btn btn-secondary editar">EDITAR</button>';
...
<li class="botones">
  <input id="grabar" type="submit" value="Darme de alta &rarr;" />
</li>
