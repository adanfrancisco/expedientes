...
$conexion = new mysqli('localhost','usuario','password','repexcel',3306);
	...
	if($resultado->num_rows > 0 ){
		...
		$objPHPExcel->getProperties()->setCreator("JD") //Autor
							 ->setLastModifiedBy("JD") //Ultimo usuario que lo modificó
							 ->setTitle("Reporte")
							 ->setSubject("Reporte mesa Entradas")
							 ->setDescription("Mesa de Entrada")
							 ->setKeywords("reporte de la mesa de entrada")
