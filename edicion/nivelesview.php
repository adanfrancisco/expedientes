...
class cniveles_view extends cniveles {
	...
	function __construct() {
		...
		$KeyUrl = "";
		if (@$_GET["Id_nivel"] <> "") {
			$this->RecKey["Id_nivel"] = $_GET["Id_nivel"];
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			...
			} elseif (@$_POST["Id_nivel"] <> "") {
				$this->Id_nivel->setFormValue($_POST["Id_nivel"]);
...
fnivelesview.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<input type="hidden" name="modal" value="<?php echo intval($niveles_view->IsModal) ?>">
<table class="table table-striped table-bordered table-hover table-condensed ewViewTable">
<?php if ($niveles->Id_nivel->Visible) { // Id_nivel ?>
	<tr id="r_Id_nivel">
		<td class="col-sm-2"><span id="elh_niveles_Id_nivel"><?php echo $niveles->Id_nivel->FldCaption() ?></span></td>
...
<?php echo $niveles->Id_nivel->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($niveles->Nivel->Visible) { // Nivel ?>
	<tr id="r_Nivel">
		<td class="col-sm-2"><span id="elh_niveles_Nivel"><?php echo $niveles->Nivel->FldCaption() ?></span></td>
