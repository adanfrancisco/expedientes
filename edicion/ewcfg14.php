...
define("EW_PROJECT_NAME", "mesa_entrada", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME, TRUE); // Config file name
define("EW_PROJECT_ID", "{803A0725-AF43-41D4-9FF6-CD1AEBA17FEC}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", '7cwA9zcfkUyvid7Z', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/mesa_entrada.css", TRUE); // Project stylesheet file name
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "ACCESS", "provider" => "Provider=Microsoft.Jet.OLEDB.4.0", "relpath" => "", "dbname" => "test.mdb", "password" => "", "qs" => "[", "qe" => "]");
...
// Database
define("EW_IS_MSACCESS", TRUE, TRUE); // Access
