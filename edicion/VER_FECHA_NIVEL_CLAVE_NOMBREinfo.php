...
$VER_FECHA_NIVEL_CLAVE_NOMBRE = NULL;

//
// Table class for VER-FECHA-NIVEL-CLAVE-NOMBRE
//
class cVER_FECHA_NIVEL_CLAVE_NOMBRE extends cTable {
	var $fecha;
	var $Nivel;
	var $CLAVE;
	var $NOMBRE;
	...
	function __construct() {
		...
		$this->TableVar = 'VER_FECHA_NIVEL_CLAVE_NOMBRE';
		$this->TableName = 'VER-FECHA-NIVEL-CLAVE-NOMBRE';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "[VER-FECHA-NIVEL-CLAVE-NOMBRE]";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// fecha
		$this->fecha = new cField('VER_FECHA_NIVEL_CLAVE_NOMBRE', 'VER-FECHA-NIVEL-CLAVE-NOMBRE', 'x_fecha', 'fecha', '[fecha]', ew_CastDateFieldForLike('[fecha]', 0, "DB"), 7, 0, FALSE, '[fecha]', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Nivel
		$this->Nivel = new cField('VER_FECHA_NIVEL_CLAVE_NOMBRE', 'VER-FECHA-NIVEL-CLAVE-NOMBRE', 'x_Nivel', 'Nivel', '[Nivel]', '[Nivel]', 202, -1, FALSE, '[Nivel]', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Nivel->Sortable = TRUE; // Allow sort
		$this->fields['Nivel'] = &$this->Nivel;

		// CLAVE
		$this->CLAVE = new cField('VER_FECHA_NIVEL_CLAVE_NOMBRE', 'VER-FECHA-NIVEL-CLAVE-NOMBRE', 'x_CLAVE', 'CLAVE', '[CLAVE]', '[CLAVE]', 202, -1, FALSE, '[CLAVE]', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CLAVE->Sortable = TRUE; // Allow sort
		$this->fields['CLAVE'] = &$this->CLAVE;

		// NOMBRE
		$this->NOMBRE = new cField('VER_FECHA_NIVEL_CLAVE_NOMBRE', 'VER-FECHA-NIVEL-CLAVE-NOMBRE', 'x_NOMBRE', 'NOMBRE', '[NOMBRE]', '[NOMBRE]', 202, -1, FALSE, '[NOMBRE]', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->NOMBRE->Sortable = TRUE; // Allow sort
		$this->fields['NOMBRE'] = &$this->NOMBRE;

		// mensaje
		$this->mensaje = new cField('VER_FECHA_NIVEL_CLAVE_NOMBRE', 'VER-FECHA-NIVEL-CLAVE-NOMBRE', 'x_mensaje', 'mensaje', '[mensaje]', '[mensaje]', 202, -1, FALSE, '[mensaje]', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "[VER-FECHA-NIVEL-CLAVE-NOMBRE]";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "VER_FECHA_NIVEL_CLAVE_NOMBRElist.php";
		}
	}
	...
	function GetModalCaption($pageName) {
		global $Language;
		if ($pageName == "VER_FECHA_NIVEL_CLAVE_NOMBREview.php")
			return $Language->Phrase("View");
		elseif ($pageName == "VER_FECHA_NIVEL_CLAVE_NOMBREedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "VER_FECHA_NIVEL_CLAVE_NOMBREadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("VER_FECHA_NIVEL_CLAVE_NOMBREview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("VER_FECHA_NIVEL_CLAVE_NOMBREview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "VER_FECHA_NIVEL_CLAVE_NOMBREadd.php?" . $this->UrlParm($parm);
		else
			$url = "VER_FECHA_NIVEL_CLAVE_NOMBREadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("VER_FECHA_NIVEL_CLAVE_NOMBREedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("VER_FECHA_NIVEL_CLAVE_NOMBREadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("VER_FECHA_NIVEL_CLAVE_NOMBREdelete.php", $this->UrlParm());
	}
