...
class cniveles extends cTable {
	...
	function __construct() {
		...
		// Id_nivel
		$this->Id_nivel = new cField('niveles', 'niveles', 'x_Id_nivel', 'Id_nivel', '[Id_nivel]', '[Id_nivel]', 3, -1, FALSE, '[Id_nivel]', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "nivelesedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "nivelesadd.php")
	...
	function GetRecordKeys() {
		...
		if (isset($_POST["key_m"])) {
			...
			if ($isPost && isset($_POST["Id_nivel"]))
				$arKeys[] = $_POST["Id_nivel"];
			elseif (isset($_GET["Id_nivel"]))
				$arKeys[] = $_GET["Id_nivel"];
			else
