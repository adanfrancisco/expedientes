...
class cniveles_edit extends cniveles {
	...
	function Page_Main() {
		...
		if (@$_POST["a_edit"] <> "") {
			...
			// Load key from Form
			if ($objForm->HasValue("x_Id_nivel")) {
			...
			if (isset($_GET["Id_nivel"])) {
				$this->Id_nivel->setQueryStringValue($_GET["Id_nivel"]);
				$loadByQuery = TRUE;
			} else {
...
fnivelesedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<input type="hidden" name="modal" value="<?php echo intval($niveles_edit->IsModal) ?>">
<div class="ewEditDiv"><!-- page* -->
<?php if ($niveles->Id_nivel->Visible) { // Id_nivel ?>
	<div id="r_Id_nivel" class="form-group">
		<label id="elh_niveles_Id_nivel" class="<?php echo $niveles_edit->LeftColumnClass ?>"><?php echo $niveles->Id_nivel->FldCaption() ?></label>
		<div class="<?php echo $niveles_edit->RightColumnClass ?>"><div<?php echo $niveles->Id_nivel->CellAttributes() ?>>
<span id="el_niveles_Id_nivel">
<span<?php echo $niveles->Id_nivel->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $niveles->Id_nivel->EditValue ?></p></span>
</span>
<input type="hidden" data-table="niveles" data-field="x_Id_nivel" name="x_Id_nivel" id="x_Id_nivel" value="<?php echo ew_HtmlEncode($niveles->Id_nivel->CurrentValue) ?>">
<?php echo $niveles->Id_nivel->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($niveles->Nivel->Visible) { // Nivel ?>
	<div id="r_Nivel" class="form-group">
		<label id="elh_niveles_Nivel" for="x_Nivel" class="<?php echo $niveles_edit->LeftColumnClass ?>"><?php echo $niveles->Nivel->FldCaption() ?></label>
		<div class="<?php echo $niveles_edit->RightColumnClass ?>"><div<?php echo $niveles->Nivel->CellAttributes() ?>>
...
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $niveles_edit->OffsetColumnClass ?>"><!-- buttons offset -->
