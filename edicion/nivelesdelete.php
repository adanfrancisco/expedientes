...
fnivelesdelete.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php if ($niveles->Id_nivel->Visible) { // Id_nivel ?>
		<th class="<?php echo $niveles->Id_nivel->HeaderCellClass() ?>"><span id="elh_niveles_Id_nivel" class="niveles_Id_nivel"><?php echo $niveles->Id_nivel->FldCaption() ?></span></th>
<?php } ?>
...
<?php if ($niveles->Id_nivel->Visible) { // Id_nivel ?>
		<td<?php echo $niveles->Id_nivel->CellAttributes() ?>>
<span id="el<?php echo $niveles_delete->RowCnt ?>_niveles_Id_nivel" class="niveles_Id_nivel">
...
<?php } ?>
<?php if ($niveles->Nivel->Visible) { // Nivel ?>
		<td<?php echo $niveles->Nivel->CellAttributes() ?>>
