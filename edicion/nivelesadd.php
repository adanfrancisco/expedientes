...
class cniveles_add extends cniveles {
	...
	function LoadDefaultValues() {
		...
		$this->INSPECTOR->CurrentValue = NULL;
		$this->INSPECTOR->OldValue = $this->INSPECTOR->CurrentValue;
	}
	...
	function NewRow() {
		...
		$row['INSPECTOR'] = $this->INSPECTOR->CurrentValue;
		return $row;
	}
	...
	function AddRow($rsold = NULL) {
		...
		// INSPECTOR
		$this->INSPECTOR->SetDbValueDef($rsnew, $this->INSPECTOR->CurrentValue, NULL, FALSE);
...
fnivelesadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<input type="hidden" name="modal" value="<?php echo intval($niveles_add->IsModal) ?>">
<div class="ewAddDiv"><!-- page* -->
<?php if ($niveles->Nivel->Visible) { // Nivel ?>
	<div id="r_Nivel" class="form-group">
		<label id="elh_niveles_Nivel" for="x_Nivel" class="<?php echo $niveles_add->LeftColumnClass ?>"><?php echo $niveles->Nivel->FldCaption() ?></label>
		<div class="<?php echo $niveles_add->RightColumnClass ?>"><div<?php echo $niveles->Nivel->CellAttributes() ?>>
...
<?php if ($niveles->INSPECTOR->Visible) { // INSPECTOR ?>
	<div id="r_INSPECTOR" class="form-group">
		<label id="elh_niveles_INSPECTOR" for="x_INSPECTOR" class="<?php echo $niveles_add->LeftColumnClass ?>"><?php echo $niveles->INSPECTOR->FldCaption() ?></label>
		<div class="<?php echo $niveles_add->RightColumnClass ?>"><div<?php echo $niveles->INSPECTOR->CellAttributes() ?>>
...
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $niveles_add->OffsetColumnClass ?>"><!-- buttons offset -->
